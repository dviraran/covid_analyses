...
getExpectedCounts = function(vac_dose,counts_data,date1,date2,days_shift,days_boundary,beta=0.5) {
  date1 = as.Date(date1)
  date2 = as.Date(date2)
...
runAnalysisForBeta = function(counts_use,vac1,vac2,counts_data) {
  d = data.frame(beta=seq(0.26,2,by=0.01))
  se = d
  
  for (i in 1:175) {
    d$Dose1.0[i] = 1-counts_use[1]/getExpectedCounts(vac1,counts_data,'2020-12-20','2021-01-31',0,14,i/100+0.25)
    d$Dose1.14[i] = 1-counts_use[2]/getExpectedCounts(vac1,counts_data,'2021-01-03','2021-01-31',14,7,i/100+0.25)
    d$Dose2.0[i] = 1-counts_use[3]/getExpectedCounts(vac2,counts_data,'2021-01-10','2021-01-31',0,7,i/100+0.25)
    d$Dose2.7[i] = 1-counts_use[4]/getExpectedCounts(vac2,counts_data,'2021-01-17','2021-01-31',7,15,i/100+0.25)
  }
...
ggsave('~/Documents/covid_analyses/figure1.pdf',width=8,height = 3)
